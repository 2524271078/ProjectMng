...
def load_local_env():
    """Load local development variables without committing credentials."""
...
if os.getenv("DB_ENGINE", "sqlite").lower() == "postgresql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "project_mng"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "accounts.authentication.IdleTimeoutTokenAuthentication",
